...
namespace azki.Persistence
{
    public class AzkiContext : DbContext
    {
        ...
        public DbSet<InstrumentColor> InstrumentColors { get; set; }
        public DbSet<Discount> Discounts { get; set; }

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Instrument>().HasMany(i => i.InstrumentColors).WithMany(i => i.Instruments);
            ...
            modelBuilder.Entity<InstrumentColor>().Property(i => i.Title).HasMaxLength(100);
            modelBuilder.Entity<InstrumentColor>().Property(i => i.Description).HasMaxLength(1000);
